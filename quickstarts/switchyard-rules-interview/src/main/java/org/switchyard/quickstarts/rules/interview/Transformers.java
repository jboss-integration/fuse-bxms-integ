...
public class Transformers {
    ...
    public Element transformBooleanToVerifyResponse(boolean b) {
        String xml = new StringBuilder()
                .append("<urn:verifyResponse xmlns:urn='urn:switchyard-quickstart:rules-interview:0.1.0'>").append("<return>")
                .append(b).append("</return>").append("</urn:verifyResponse>").toString();
