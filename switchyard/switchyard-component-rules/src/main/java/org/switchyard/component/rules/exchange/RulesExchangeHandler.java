...
public class RulesExchangeHandler extends KnowledgeExchangeHandler {
    ...
    private final class FireUntilHalt implements Runnable, DisposeListener {
        ...
        private Thread startThread() {
            ...
            String name = new StringBuilder().append(_handler.getClass().getSimpleName()).append(':').append(getClass().getSimpleName()).append(':')
                .append(FIRE_UNTIL_HALT_COUNT.incrementAndGet()).toString();
            thread.setName(name);
