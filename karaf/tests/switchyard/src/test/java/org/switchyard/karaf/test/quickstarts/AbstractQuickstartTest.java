...
public abstract class AbstractQuickstartTest {
    ...
    private static Option[] config(String featureName, String bundleName) throws Exception {
        ...
        return options(
                ...
                features(maven().groupId("org.jboss.integration.karaf").artifactId("fuse-bxms-integration").type("xml").classifier("features").versionAsInProject().getURL(), featureName),
