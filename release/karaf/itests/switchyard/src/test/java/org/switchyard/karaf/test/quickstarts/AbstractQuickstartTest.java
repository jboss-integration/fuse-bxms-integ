    ...
    private static Option[] config(String featureName, String bundleName) throws Exception {
        ...
        return options(
                ...
                editConfigurationFilePut(
                        ...
                        "https://repository.apache.org/content/groups/snapshots@snapshots@noreleases@id=apache-snapshot, https://repository.jboss.org/nexus/content/groups/public@id=jboss-public-repository-group,http://repo1.maven.org/maven2@id=central, http://svn.apache.org/repos/asf/servicemix/m2-repo@id=servicemix, http://repository.springsource.com/maven/bundles/release@id=springsource.release, http://repository.springsource.com/maven/bundles/external@id=springsource.external, https://repository.jboss.org/nexus/content/repositories/snapshots@snapshots@noreleases@id=jboss-snapshot, https://repository.jboss.org/nexus/content/repositories/fs-releases@id=fusesource.release, https://repository.jboss.org/nexus/content/groups/ea@id=ea, http://download.eng.bos.redhat.com/brewroot/repos/jb-fsw-6.2-build/latest/maven@id=brewroot"),
                ...
                features(maven().groupId("org.apache.karaf.assemblies.features").artifactId("brms-features").type("xml").classifier("features").versionAsInProject().getURL()),
