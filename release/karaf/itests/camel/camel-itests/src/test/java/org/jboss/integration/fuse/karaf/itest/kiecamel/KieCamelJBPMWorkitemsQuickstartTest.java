...
public class KieCamelJBPMWorkitemsQuickstartTest {
    ...
    private static String FEATURE_NAME = "fuse-bxms-quickstart-camel-jbpm-workitems";
    ...
    public static Option[] configure() {
        ...
        options.add(org.ops4j.pax.exam.CoreOptions.bundle(org.ops4j.pax.exam.CoreOptions.mavenBundle().
                                                          groupId("org.apache.httpcomponents").
                                                          artifactId("httpclient-osgi")
                                                          .version("4.3.6").getURL()));
        options.add(org.ops4j.pax.exam.CoreOptions.bundle(org.ops4j.pax.exam.CoreOptions.mavenBundle().
                                                          groupId("org.apache.httpcomponents").
                                                          artifactId("httpcore-osgi").
                                                          version("4.3.3").getURL()));
        /*options.add(org.ops4j.pax.exam.CoreOptions.mavenBundle().
